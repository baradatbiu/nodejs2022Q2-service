...
export class tracks1658510119709 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "artists" ADD CONSTRAINT "UQ_2ac64cc2acd200fad5e8c212455" UNIQUE ("trackId")`);
        await queryRunner.query(`ALTER TABLE "albums" ADD "trackId" uuid`);
        await queryRunner.query(`ALTER TABLE "albums" ADD CONSTRAINT "UQ_5669eb313fe1a8f207a9327bb5c" UNIQUE ("trackId")`);
        ...
        await queryRunner.query(`ALTER TABLE "artists" ADD CONSTRAINT "FK_2ac64cc2acd200fad5e8c212455" FOREIGN KEY ("trackId") REFERENCES "tracks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "albums" ADD CONSTRAINT "FK_5669eb313fe1a8f207a9327bb5c" FOREIGN KEY ("trackId") REFERENCES "tracks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "albums" DROP CONSTRAINT "FK_5669eb313fe1a8f207a9327bb5c"`);
        await queryRunner.query(`ALTER TABLE "artists" DROP CONSTRAINT "FK_2ac64cc2acd200fad5e8c212455"`);
        ...
        await queryRunner.query(`ALTER TABLE "albums" DROP CONSTRAINT "UQ_5669eb313fe1a8f207a9327bb5c"`);
        await queryRunner.query(`ALTER TABLE "albums" DROP COLUMN "trackId"`);
        await queryRunner.query(`ALTER TABLE "artists" DROP CONSTRAINT "UQ_2ac64cc2acd200fad5e8c212455"`);
